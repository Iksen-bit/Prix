...
import 'package:myapp/find_exercise_page.dart';
            ...
            Expanded(
              child: GridView.count(
                ...
                children: [
                  ...
                  _buildModuleCard(
                    context: context,
                    icon: Icons.qr_code_scanner, // Ícono de QR
                    title: 'Buscar Ejercicio', // Título más corto
                    page: const FindExercisePage(), // Navega a FindExercisePage
                  ),
                  // *************************************
                  _buildModuleCard(
                    context: context,
